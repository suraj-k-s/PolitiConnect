...
public final class NewUser_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <link rel='stylesheet' href='https://cdn.datatables.net/buttons/1.2.2/css/buttons.bootstrap.min.css'>\n");
      out.write("        <style>\n");
      out.write("            body {\n");
      out.write("                margin:2em;\n");
      out.write("                //background-color: #EFF1F7;\n");
      out.write("            }\n");
      out.write("        </style>\n");
      out.write("        ");
      ...
      out.write("    ");
        ...
        if (request.getParameter("aid") != null) {
                ...
                String upQry = "update tbl_user set user_status='1' where user_id='" + request.getParameter("aid") + "'";
        ...
        if (request.getParameter("rid") != null) {
                ...
                String upQry = "update tbl_user set user_status='2' where user_id='" + request.getParameter("rid") + "'";
                if (con.executeCommand(upQry)) {
      ...
      out.write("\n");
      out.write("    <body>\n");
      out.write("        <h1 align=\"center\" id=\"heading\">User Data</h1>\n");
      ...
      out.write("                        <a href=\"NewUser.jsp?aid=");
      out.print(rs.getString("user_id"));
      out.write("&mailid=");
      out.print(rs.getString("user_email"));
      out.write("&name=");
      out.print(rs.getString("user_name"));
      out.write("\"><img src=\"../Assets/check.png\" width=\"25\" height=\"25\"></a>&nbsp;&nbsp;&nbsp;&nbsp;\n");
      out.write("                        <a href=\"NewUser.jsp?rid=");
      out.print(rs.getString("user_id"));
      out.write("&mailid=");
      out.print(rs.getString("user_email"));
      out.write("&name=");
      out.print(rs.getString("user_name"));
      out.write("\"><img src=\"../Assets/remove.png\"  width=\"25\" height=\"25\"></a>\n");
      out.write("                    </td>\n");
      out.write("                </tr>\n");
      out.write("                ");
      ...
      out.write("                                            }\n");
      out.write("                                        });\n");
      out.write("                                        // Create a footer object with 2 columns\n");
      out.write("                                        // Left side: report creation date\n");
      out.write("                                        // Right side: current page and total pages\n");
      out.write("                                        doc['footer'] = (function(page, pages) {\n");
      out.write("                                            return {\n");
      out.write("                                                columns: [\n");
      out.write("                                                    {\n");
      out.write("                                                        alignment: 'left',\n");
      out.write("                                                        text: ['Created on: ', {text: jsDate.toString()}]\n");
      out.write("                                                    },\n");
      out.write("                                                    {\n");
      out.write("                                                        alignment: 'right',\n");
      out.write("                                                        text: ['page ', {text: page.toString()}, ' of ', {text: pages.toString()}]\n");
      out.write("                                                    }\n");
      out.write("                                                ],\n");
      out.write("                                                margin: 20\n");
      out.write("                                            }\n");
      out.write("                                        });\n");
      out.write("                                        // Change dataTable layout (Table styling)\n");
      out.write("                                        // To use predefined layouts uncomment the line below and comment the custom lines below\n");
      out.write("                                        // doc.content[0].layout = 'lightHorizontalLines'; // noBorders , headerLineOnly\n");
      out.write("                                        var objLayout = {};\n");
      out.write("                                        objLayout['hLineWidth'] = function(i) {\n");
      out.write("                                            return .5;\n");
      out.write("                                        };\n");
      out.write("                                        objLayout['vLineWidth'] = function(i) {\n");
      out.write("                                            return .5;\n");
      out.write("                                        };\n");
      out.write("                                        objLayout['hLineColor'] = function(i) {\n");
      out.write("                                            return '#aaa';\n");
      out.write("                                        };\n");
      out.write("                                        objLayout['vLineColor'] = function(i) {\n");
      out.write("                                            return '#aaa';\n");
      out.write("                                        };\n");
      out.write("                                        objLayout['paddingLeft'] = function(i) {\n");
      out.write("                                            return 4;\n");
      out.write("                                        };\n");
      out.write("                                        objLayout['paddingRight'] = function(i) {\n");
      out.write("                                            return 4;\n");
      out.write("                                        };\n");
      out.write("                                        doc.content[0].layout = objLayout;\n");
      out.write("                                    }\n");
      out.write("                                }]\n");
      out.write("                        });\n");
      out.write("            });\n");
