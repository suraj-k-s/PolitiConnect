...
<nav class="sidebar">
    ...
    <ul id="sidebar_menu">
        ...
        <li class="side_menu_title">
         ...
         <li class="">
            <a   class="has-arrow" href="Notification.jsp" aria-expanded="false">
                <img src="../Assets/admin/img/menu-icon/2.svg" alt="">
         ...
         <li class="">
            <a   class="has-arrow" href="Timeline.jsp" aria-expanded="false">
                <img src="../Assets/admin/img/menu-icon/2.svg" alt="">
                <span>Add post</span>
            </a>
         </li>
         <li class="side_menu_title" >
            ...
            <a   class="has-arrow" href="partyfund.jsp" aria-expanded="false">
                <img src="../Assets/admin/img/menu-icon/2.svg" alt="">
                <span>Add payment scheme</span>
            </a>
            <a   class="has-arrow" href="viewpayment.jsp" aria-expanded="false">
                <img src="../Assets/admin/img/menu-icon/2.svg" alt="">
        ...
        <li class="">
            <a   class="has-arrow" href="ViewUserComplaint.jsp" aria-expanded="false">
                <img src="../Assets/admin/img/menu-icon/2.svg" alt="">
