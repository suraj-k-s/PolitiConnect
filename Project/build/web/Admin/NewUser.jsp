        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td align="center">
                        <a href="NewUser.jsp?aid=<%=rs.getString("user_id")%>&mailid=<%=rs.getString("user_email")%>&name=<%=rs.getString("user_name")%>"><img src="../Assets/check.png" width="25" height="25"></a>&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="NewUser.jsp?rid=<%=rs.getString("user_id")%>&mailid=<%=rs.getString("user_email")%>&name=<%=rs.getString("user_name")%>"><img src="../Assets/remove.png"  width="25" height="25"></a>
                    </td>
                </tr>
                <%
                    }
