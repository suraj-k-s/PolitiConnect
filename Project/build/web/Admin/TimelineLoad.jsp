    ...
    <body onload="loadPage()">
        ...
        <script>
                                    ...
                                    function deletePost(id)
                                    {
                                        ...
                                        $.ajax({url: "../Assets/AjaxPages/AjaxDeletePostAdmin.jsp?id=" + id,
                                            success: function() {
                                                loadPage();
                                            }});
                                    }
                                    ...
                                    function insPost()
                                    {
                                        ...
                                        if (div.trim() === "")
                                        {
                                            ...
                                            $.ajax({
                                                type: 'POST',
                                                url: '../Assets/AjaxPages/AjaxPostAdmin.jsp',
                                    ...
                                    function loadPage()
                                    {
                                        $("#post-load").load('../Assets/AjaxPages/AjaxPostLoadAdmin.jsp');
                                    }
                                    ...
                                    function onLike(img)
                                    {
                                        ...
                                        if (name === 'heart-b.svg')
                                        {
                                            ...
                                            $.ajax({
                                                type: 'POST',
                                                url: '../Assets/AjaxPages/AjaxLikeAdmin.jsp',
                                                data: {id: id},
                                                success: function(result) {
                                                    loadPage();
                                        ...
                                        else if (name === 'heart-r.svg')
                                        {
                                            ...
                                            $.ajax({
                                                type: 'POST',
                                                url: '../Assets/AjaxPages/AjaxDislikeAdmin.jsp',
                                                data: {id: id},
                                                success: function(result) {
                                                    loadPage();
                                    ...
                                    function comment(id)
                                    {
                                        ...
                                        $.ajax({
                                            type: 'POST',
                                            url: '../Assets/AjaxPages/AjaxCommentAdmin.jsp',
                                            data: {id: id,
                                                content: content},
                                            success: function(result) {
                                                loadPage();
