...
<%
    String selQry = "select * from tbl_chat cdc inner join tbl_college c on (cdc.to_college_id=c.college_id) or (cdc.from_college_id=c.college_id) where c.college_id='" + session.getAttribute("dcid") + "' order by cdc_id";
...
} else if (rs.getString("from_college_id").equals(session.getAttribute("dcid"))) {
%>
