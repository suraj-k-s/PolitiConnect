                            ...
                            <div class="nav-drop">
                                <div class="inner">
                                    ...
                                    <div class="nav-drop-body is-notifications">
                                        ...
                                        <%
                                            String selNoti = "select notification_id as id,notification_title as title,notification_content as content,notification_datettime as date from tbl_notification limit 4";
                                            ResultSet rsNoti = con.selectCommand(selNoti);
                                        ...
                                        <div class="media">
                                            <div class="media-content">
                                                <span><a href="javascript:void(0)"><%=rsNoti.getString("title")%> </a></span>
                                                <span><%=rsNoti.getString("content")%> </span>
                                                <span class="time"><%=rsNoti.getString("date")%></span>
                                            </div>
                                        </div>
                                        <%
                                            }
                            ...
                            <div class="card">
                                <div class="card-heading is-bordered">
                                    ...
                                    <div class="dropdown is-spaced is-neutral is-right dropdown-trigger">
                                        <div>
                                            <div class="button">
                                                <a href="UserList.jsp" >  <i data-feather="more-vertical"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
