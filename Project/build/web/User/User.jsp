<%-- 
    Document   : User
    Created on : May 12, 2021, 10:58:17 PM
    Author     : Pro-TECH
--%>
...
<html lang="en" >
    ...
    <body>
        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                     int i = 0;
                    String selQry = "select * from tbl_user s inner join tbl_place p on p.place_id=s.place_id inner join tbl_district dis on dis.district_id=p.district_id where s.user_id!='" + session.getAttribute("uid") + "'";
