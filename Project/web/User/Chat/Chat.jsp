...
<jsp:useBean class="DB.ConnectionClass" id="con"></jsp:useBean>
    ...
    %>
    <%
        String selQry1 = "select * from tbl_user where user_id='" + request.getParameter("uid") + "'";
                    ...
                    <div class="nav-start">
                        <div class="recipient-block">
                            <div class="avatar-container">
                                <img class="user-avatar" src="<%=rs1.getString("user_photo")%>" alt="">
                            </div>
                            <div class="username">
                    ...
                    <div class="chat-action">
                        <div class="chat-action-inner">
                            <div class="control" style="text-align: center">
                                ...
                                <input type="hidden" value="<%=request.getParameter("uid")%>" name="uid" id="uid"/>
